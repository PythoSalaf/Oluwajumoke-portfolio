      ...
      <div className="layout flex items-center justify-between flex-col md:flex-row gap-8 md:gap-0">
        ...
        <div className="w-full mx-auto ">
          ...
          <div className="flex items-center justify-center md:justify-start w-full mt-10 gap-x-7">
            <button className="bg-black rounded-xl text-white py-2 w-[80%] md:w-[50%] lg:w-[25%] text-base  md:text-lg capitalize">
              view resume
            </button>
            <button className="bg-black rounded-xl text-white py-2 w-[90%] md:w-[60%] lg:w-[30%] text-base  md:text-lg capitalize">
              reach out
            </button>
          </div>
        </div>
