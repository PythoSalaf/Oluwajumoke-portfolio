const About = () => {
  return (
    <div className="w-full my-14" id="about">
      <div className="layout">
        ...
        <div className="mt-5">
          <p className=" text-lg md:text-xl font-medium">
            ...
            every interaction is both meaningful and memorable. I focus on
          ...
          <p className="my-4 md:my-[2rem] text-lg md:text-xl font-medium  ">
            ...
            problems in a way that resonates with users. I aim to make
            technology more approachable and enjoyable for everyone. By
            designing thoughtfully and intentionally, I contribute to building
            products that not only meet user needs but also exceed their
